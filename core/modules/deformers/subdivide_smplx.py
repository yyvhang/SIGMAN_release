...
def get_seg_mask(smplx_face, other_ids=None):
    ...
    smplx_segs = json.load(open(f'/cpfs01/user/yangyuhang/E3Gen-main/work_dirs/cache/template/smplx_vert_segmentation.json'))
    flame_segs = pickle.load(open(f'/cpfs01/user/yangyuhang/E3Gen-main/work_dirs/cache/template/FLAME_masks.pkl', 'rb'), encoding='latin1')
    smplx_flame_vid = np.load(f"/cpfs01/user/yangyuhang/E3Gen-main/work_dirs/cache/template/SMPL-X__FLAME_vertex_ids.npy", allow_pickle=True)
...
if __name__ == '__main__':
    ...
    smplx_mesh = load_obj('./template/smplx_mouth_uv.obj')
    ...
    np.save('./template/init_podir_smplx_thu.npy', dense_posedirs.transpose(2, 0, 1).reshape(486, -1))
    np.save('./template/init_spdir_smplx_thu.npy', dense_shapedirs.reshape(-1, 3, 20))
    ...
    np.save('./template/outside_mask_thu.npy', np.array(~dense_outside_masks))
    np.save('./template/face_mask_thu.npy', np.array(~dense_face_masks))
    np.save('./template/hands_mask_thu.npy', np.array(~dense_hands_masks))
    ...
    np.save('./template/init_lbsw_smplx_thu.npy', final_blendweights)
    ...
    write_obj('./template/dense_thuman.obj', dense_v_cano, dense_faces, dense_uv, dense_uv_faces)