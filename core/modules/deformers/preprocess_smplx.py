...
if __name__ == '__main__':
    ...
    smplx_flame_correspond = np.load('./template/SMPL-X__FLAME_vertex_ids.npy')
    ...
    output_obj_path = './template/smplx_mouth_uv.obj'
