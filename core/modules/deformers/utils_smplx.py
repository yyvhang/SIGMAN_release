...
if __name__ == '__main__':
    ...
    np.save('./template/init_faces_smplx_thu.npy', vi.numpy())
    np.save('./template/init_uv_smplx_thu.npy', final_uv[0].numpy())
    np.save('./template/init_pcd_smplx_thu.npy', final_pos[0].numpy())
    np.save('./template/init_rot_smplx_thu.npy', final_rot[0].numpy())