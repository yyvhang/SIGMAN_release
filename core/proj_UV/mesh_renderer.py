...
class Renderer(nn.Module):
    ...
    def load_mesh(self, path):
        ...
        smplx_mesh = Mesh.load('./smplx_uv.obj', front_dir=self.opt.front_dir, retex=self.opt.retex, remesh=self.opt.remesh, device=self.device)
        self.mesh.vt = smplx_mesh.vt
        self.mesh.ft = smplx_mesh.ft
